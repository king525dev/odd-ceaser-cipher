...
(function () {
  const modules = { './main/decrypt/blockCipherRev': null,'./main/decrypt/decrypt': null,'./main/decrypt/legacy/ceasersPositionRev': null,'./main/decrypt/legacy/revCeaser': null,'./main/decrypt/legacy/revOddCeaser': null,'./main/decrypt/legacy/revSimpleCeaser': null,'./main/decrypt/legacy/revUnicodeShift': null,'./main/encrypt/blockCipher': null,'./main/encrypt/encrypt': null,'./main/encrypt/kdf': null,'./main/encrypt/legacy/ceaser': null,'./main/encrypt/legacy/ceasersPosition': null,'./main/encrypt/legacy/oddCeaser': null,'./main/encrypt/legacy/simpleCeaser': null,'./main/encrypt/legacy/unicodeShift': null,'./main/factorFinder': null,'./main/keyGenerator': null };
  const cache = {};
  ...
  modules['./main/decrypt/blockCipherRev'] = function (module, exports, require) {
...
module.exports = { decryptWithBlockCipher };
  ...
  modules['./main/decrypt/decrypt'] = function (module, exports, require) {
const oddCeaser = require('./main/decrypt/legacy/revOddCeaser');
const newKey = require('./main/keyGenerator');
const ceaser = require('./main/decrypt/legacy/revCeaser');
const reposition = require('./main/decrypt/legacy/ceasersPositionRev');
...
module.exports = decrypt;
  ...
  modules['./main/decrypt/legacy/ceasersPositionRev'] = function (module, exports, require) {
const { singleDecrypt } = require('./main/decrypt/legacy/revUnicodeShift');
...
module.exports = { ceasersPosition, cog };
  ...
  modules['./main/decrypt/legacy/revCeaser'] = function (module, exports, require) {
const { decryptString } = require('./main/decrypt/legacy/revUnicodeShift');
...
module.exports = decrypt;
  ...
  modules['./main/decrypt/legacy/revOddCeaser'] = function (module, exports, require) {
const { singleDecrypt } = require('./main/decrypt/legacy/revUnicodeShift');
...
module.exports = oddCeaser;
  ...
  modules['./main/decrypt/legacy/revSimpleCeaser'] = function (module, exports, require) {
...
module.exports = {
  ...
  modules['./main/decrypt/legacy/revUnicodeShift'] = function (module, exports, require) {
...
module.exports = { singleDecrypt, decryptString };
  ...
  modules['./main/encrypt/blockCipher'] = function (module, exports, require) {
...
module.exports = { encryptWithBlockCipher };
  ...
  modules['./main/encrypt/encrypt'] = function (module, exports, require) {
const newKey = require('./main/keyGenerator');
const ceaserCipher = require('./main/encrypt/legacy/ceaser');
const oddCeaser = require('./main/encrypt/legacy/oddCeaser');
const reposition = require('./main/encrypt/legacy/ceasersPosition');
const { deriveKeys } = require('./main/encrypt/kdf');
...
module.exports = encrypt;
  ...
  modules['./main/encrypt/kdf'] = function (module, exports, require) {
...
module.exports = { deriveKeys };
  ...
  modules['./main/encrypt/legacy/ceaser'] = function (module, exports, require) {
const { encryptString } = require('./main/encrypt/legacy/unicodeShift');
...
module.exports = encrypt;
  ...
  modules['./main/encrypt/legacy/ceasersPosition'] = function (module, exports, require) {
const { singleEncrypt } = require('./main/encrypt/legacy/unicodeShift');
...
module.exports = { ceasersPosition, cog };
  ...
  modules['./main/encrypt/legacy/oddCeaser'] = function (module, exports, require) {
const { singleEncrypt } = require('./main/encrypt/legacy/unicodeShift');
...
module.exports = oddCeaser;
  ...
  modules['./main/encrypt/legacy/simpleCeaser'] = function (module, exports, require) {
function singleCeaser(str, shift, dict) {
    const index = dict.indexOf(str);
    if (index > -1) {
        const newIndex = (index - shift + dict.length) % dict.length;
        str = dict[newIndex];
    }
    return str;
}
...
module.exports = {
  ...
  modules['./main/encrypt/legacy/unicodeShift'] = function (module, exports, require) {
...
module.exports = { singleEncrypt, encryptString };
  ...
  modules['./main/factorFinder'] = function (module, exports, require) {
...
module.exports = findFactors;
  ...
  modules['./main/keyGenerator'] = function (module, exports, require) {
